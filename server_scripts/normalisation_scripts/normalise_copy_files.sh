...
for f in `seq 0 5`; do echo $f; scp normalise_run_tiles_$f.sh ubuntu@eecolidar$f.eecolidar-nlesc.surf-hosted.nl:/home/ubuntu/normalisation_scripts/; scp normalise_tiles_$f.sh ubuntu@eecolidar$f.eecolidar-nlesc.surf-hosted.nl:/home/ubuntu/normalisation_scripts/; done